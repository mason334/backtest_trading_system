...
但是仅仅一次取样，样本量可能很小，所以我们在不重合的时间上重复上述过程，t1 t2 都更新到t3+1。多次取样，将样本汇总到一起，然后做出直方图，计算描述性统计数据。
...
if __name__ == '__main__':
    ...
    symbol_list = ['QQQ']
    output_folder = 'E:\\Strategy_output\\distribution_analysis\\2021-07-20_v2'
